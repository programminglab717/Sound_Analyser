...
/// And it would be a claim of portability this application cannot honour
/// anyway: the spectrogram tile cache is already in %LOCALAPPDATA%, so "leaves
/// no trace outside its folder" is not true however the settings are stored.
///
